...
(function ($) {
    ...
    function setUp($el, settings) {
        ...
        // width and hei    ght might override default_ratio value
        ...
        innerHtml.push('<a id="lazyYT-title-', id, '" class="html5-title-text" target="_system" tabindex="3100" href="https://www.youtube.com/watch?v=', id, '&', youtube_parameters, '">');
